...
class MoeArguments:
    ...
    moe_num_heads: Optional[int] = field(
        default=4,
    ...
    use_polarization_loss: Optional[bool] = field(
        default=False,
        metadata={"help": "The distance for moe fine-tuning."}
    )
    polarization_coef: Optional[float] = field(
        default=2,
        metadata={"help": "num heads"}
    )
    polarization_func: Optional[str] = field(
        default="powsum",
        metadata={"help": "num heads"}
    )
    save_router_logits: Optional[bool] = field(
        default=False,
        metadata={"help": "num heads"}
    )
    ...
    use_load_balancing_loss: Optional[bool] = field(
        default=False,
        metadata={"help": "The distance for moe fine-tuning."}
    )
    ce_loss_coef: Optional[float] = field(
        default=None,
        metadata={"help": "num heads"}
    )
...
class MergeArguments:
    small_path: Optional[str] = field(
        default="",
        metadata={"help": "small model path"}
    )
    large_path: Optional[str] = field(
        default="",
        metadata={"help": "large model path"}
    )
    every_k_layers_small: Optional[int] = field(
        default=3,
        metadata={"help": "every_k_layers_small"}
    )
    every_k_layers_large: Optional[int] = field(
        default=4,
        metadata={"help": "every_k_layers_large"}
    )
...
@dataclass
class FinetuningArguments(FreezeArguments, LoraArguments, MoeArguments, MergeArguments, RLHFArguments):
    r"""
    ...
    finetuning_type: Optional[Literal["lora", "freeze", "full", "moe", "ffn", "moea", "ca"]] = field(
